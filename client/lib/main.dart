...
Future<void> main() async {
  ...
  runApp(LoadingScreen(status: status));

  UpdateInfo? preFetchedUpdate;
  try {
    status.value = 'Проверка обновлений...';
    preFetchedUpdate = await GithubUpdateService.prefetchUpdate();
  } catch (_) {}

  try {
    status.value = 'Инициализация базы данных...';
