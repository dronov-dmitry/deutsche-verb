            ...
            child: ListView(
              ...
              children: ['All', 'A1', 'A2', 'B1', 'B2', 'C1'].map((level) {
                return Padding(
                  ...
                  child: ChoiceChip(
                    label: Text(level == 'All' ? Strings.of('all', loc) : level, style: const TextStyle(fontSize: 13)),
  ...
  Widget build(BuildContext context) {
    return _CardSurface(
      child: Column(
        ...
        children: [
          Text(verb.translationFor(locale), style: Theme.of(context).textTheme.headlineMedium),
