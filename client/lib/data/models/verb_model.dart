// Verb data model with JSON/DB serialisation and locale-aware helpers.
...
class VerbModel {
  const VerbModel({
    ...
    this.description = '',
    this.descriptionUk = '',
    this.descriptionVerbformen = '',
    this.descriptionVerbformenUk = '',
    this.verbformenUrl = '',
  });
  ...
  factory VerbModel.fromJson(Map<String, dynamic> json) {
    return VerbModel(
      ...
      descriptionVerbformen: json['description_verbformen'] as String? ?? '',
      descriptionVerbformenUk: json['description_verbformen_uk'] as String? ?? '',
      verbformenUrl: json['verbformen_url'] as String? ?? '',
    );
  }
  ...
  factory VerbModel.fromDb(Map<String, dynamic> row) {
    return VerbModel(
      ...
      descriptionVerbformen: row['description_verbformen'] as String? ?? '',
      descriptionVerbformenUk: row['description_verbformen_uk'] as String? ?? '',
      verbformenUrl: row['verbformen_url'] as String? ?? '',
    );
  }
  ...
  final String descriptionVerbformen;
  final String descriptionVerbformenUk;
  final String verbformenUrl;
  ...
  String descriptionVerbformenFor(String locale) {
    if (locale == 'uk' && descriptionVerbformenUk.isNotEmpty) {
      return descriptionVerbformenUk;
    }
    return descriptionVerbformen;
  }

  String verbformenUrlFor(String locale) {
    if (verbformenUrl.isEmpty) return verbformenUrl;
    if (locale == 'uk' || locale == 'ru') {
      return '$verbformenUrl&tl=$locale';
    }
    return verbformenUrl;
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'description_verbformen': descriptionVerbformen,
      'description_verbformen_uk': descriptionVerbformenUk,
      'verbformen_url': verbformenUrl,
    };
  }
  ...
  VerbModel copyWith({
    ...
    return VerbModel(
      ...
      markedForRepeat: markedForRepeat ?? this.markedForRepeat,
      description: description,
      descriptionUk: descriptionUk,
      descriptionVerbformen: descriptionVerbformen,
      descriptionVerbformenUk: descriptionVerbformenUk,
      verbformenUrl: verbformenUrl,
    );
  }
}
